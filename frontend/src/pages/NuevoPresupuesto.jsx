...
export default function NuevoPresupuesto() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await createPresupuesto(payload)
      navigate(`/presupuestos/${data.data.presupuesto.id}`)
    } catch (err) {
  ...
  if (loading) {
    return <div className={styles.page}><p className={styles.state}>Cargando...</p></div>
  }

  return (
    <div className={styles.page}>
      <div className={styles.pageHeader}>
        <Link to="/historial" className={styles.back}>← Volver</Link>
          ...
          <aside className={styles.sidebar}>
            <div className={styles.card}>
              ...
              <div className={styles.actions}>
                ...
                <Link to="/historial" className={styles.btnCancel}>Cancelar</Link>
              </div>
            </div>
          </aside>
